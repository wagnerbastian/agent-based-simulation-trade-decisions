...
var PairingService = /** @class */ (function () {
     ...
     */
    PairingService.prototype.networkPairAgentsForTrade = function (agents) {
    ...
    PairingService.prototype.searchTradePartner = function (agent) {
        ...
        if (!moves) {
            var partner = this.getTradableNeighbor(agent.node.neighbors);
     ...
     */
    PairingService.prototype.getTradableNeighbor = function (neighbors) {
        var _this = this;
        ...
        if (possibleNeighbors.length > 0) {
            ...
            var index = Math.floor(Math.random() * possibleNeighbors.length);
